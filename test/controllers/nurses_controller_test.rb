...
class NursesControllerTest < ActionController::TestCase
  ...
  test "should create nurse" do
    assert_difference('Nurse.count') do
      post :create, nurse: { hourly_wage: @nurse.hourly_wage, lastname: @nurse.lastname, name: @nurse.name, nurse_id: @nurse.nurse_id, undergraduate_university: @nurse.undergraduate_university }
    end
  ...
  test "should update nurse" do
    patch :update, id: @nurse, nurse: { hourly_wage: @nurse.hourly_wage, lastname: @nurse.lastname, name: @nurse.name, nurse_id: @nurse.nurse_id, undergraduate_university: @nurse.undergraduate_university }
    assert_redirected_to nurse_path(assigns(:nurse))
  end
