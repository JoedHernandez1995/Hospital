class BloodChemistryTestsController < ApplicationController
  ...
  private
    ...
    def blood_chemistry_test_params
      params.require(:blood_chemistry_test).permit(:glucose, :urea, :uric_acid, :creatinine, :cholesterol, :hdl, :ldl, :triglycerides, :got, :gpt, :ggt, :alkaline_phosphatase, :calcium, :iron, :sodium, :bilirubin, :test_date, :patient_id, :microbiologist_id, :exam_cost)
    end
end
