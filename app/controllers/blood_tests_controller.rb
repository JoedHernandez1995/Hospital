class BloodTestsController < ApplicationController
  ...
  private
    ...
    def blood_test_params
      params.require(:blood_test).permit(:examination_date, :rbc, :hemoglobin, :vcm, :hcm, :lymphocytes, :leukocytes, :neutrophils, :eosinophils, :platelets, :vsg, :patient_id, :microbiologist_id, :exam_cost)
    end
end
